...
public class SocialConnectWS {
    ...
    private String callWS(String jsondata) {
        ...
        try {
            ...
            String URL = Constant.WS_URL+""+Constant.social_connectWS;
    ...
    public String validate(String strValue) {
        ...
        try {
            ...
            if(status.equalsIgnoreCase("success"))
            {
                ...
                Configuration.setSharedPrefrenceValue(context, Constant.PREFS_NAME, Constant.FIRST_NAME, String.valueOf(jsonObject.get("name").toString()));
