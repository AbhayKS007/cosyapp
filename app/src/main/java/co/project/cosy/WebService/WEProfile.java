...
/**
 * Created by Saurabh Saini on 1/17/2018.
 */

public class WEProfile {
    Context context;
    ...
    private String callWS(String jsondata) {
        ...
        try {
            ...
            String URL = Constant.WS_URL+""+Constant.WS_PROFILE;
    ...
    public String validate(String strValue) {
        ...
        try {
            ...
            if(status.equalsIgnoreCase("success"))
            {
                ...
                String plans= String.valueOf(jsonObject.get("user"));
                homeMethod("["+plans+"]");
