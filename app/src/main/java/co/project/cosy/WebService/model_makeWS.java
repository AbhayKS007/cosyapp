...
public class model_makeWS {
    ...
    private String callWS(String jsondata) {
        ...
        try {
            ...
            String URL = Constant.WS_URL+""+Constant.WSmodel_make;
    ...
    public String validate(String strValue) {
        ...
        try {
            ...
            {
                Constant.vehicleID_make.clear();
                Constant.model_name_make.clear();
    ...
    public void cropping_demonstration(String data)
    {
        ...
        try {
            ...
            for(int i=0;i<jsonArrayObject.size();i++)
            {
                ...
                Constant.vehicleID_make.add(jsonObject.get("vehicleID").toString());
                Constant.model_name_make.add(jsonObject.get("model_name").toString());
